...
export default function About() {
  ...
  return (
    <>
      {/*Transparent mesh for speechbubble image */}
        ...
        <Html>
          <div id="aboutme">
            <p>
              ...
              currently studying <strong>Creative Computing BSc</strong> at the
              University of the Arts London. <br />I enjoy intertwining{" "}
              <strong>technology </strong> with <strong>design</strong> and
              creative practices. <br />
              Currently my passion lies in exploring <strong>WebGL</strong> and
              building my foundation of <strong>3D </strong>knowledge. <br />
              Click on me to view my CV. <br />
              If you have any questions or want to connect feel free to contact
              me.
            </p>
          </div>
        </Html>
